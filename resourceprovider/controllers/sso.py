...
def create(subscription_id, cloud_service_name, resource_type, resource_name):
    ...
    signature = "%s:%s:%s:%s:%s" % (subscription_id, cloud_service_name, resource_type, resource_name, sso_secret)
...
def get(subscription_id, cloud_service_name, resource_type, resource_name, token, timestamp):
    ...
    """
    local_token, local_timestamp = create(subscription_id, cloud_service_name, resource_type, resource_name)
    # do the tokens match?
